...
/**
 * A panel for viewing and editing {@link no.ntnu.fp.model.User} objects. The various
...
{
    /**
     * The underlying data model is the {@link no.ntnu.fp.model.User} class.
     */
    private User model;
     ...
     * i.e. {@link no.ntnu.fp.model.User}, and to the value property of the 
    ...
    private void updatePanel(String property) {
        ...
        if (propertyChanged(property, User.NAME_PROPERTY_NAME, nameTextField)) {
            String name = (model != null ? model.getName() : "");
            nameTextField.setText(name != null ? name : "");
        }

        if (propertyChanged(property, User.EMAIL_PROPERTY_NAME, emailTextField)) {
            String email = (model != null ? model.getEmail() : "");
            emailTextField.setValue(email);
        }

        if (propertyChanged(property, User.DATEOFBIRTH_PROPERTY_NAME, dateOfBirthTextField)) {
